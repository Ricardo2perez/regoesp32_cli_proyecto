<template>
  <main id="main-container">
    ...
    <!-- Page Content -->
    <div class="content">
        <h2 class="content-heading">RegoEsp32</h2>
        <div class="row">
                                                ...
                                                <div class="block-content">
                                                    ...
                                                    <div class="col-12 mb-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="dir_wifi_ipv4" class="form-control" placeholder="192.168.20.100" v-model.trim="wifi.wifi_ipv4" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12 mb-2">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-12 mb-2">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <input type="text" id="p_wifi_gateway" class="form-control" placeholder="192.168.20.1" v-model.trim="wifi.wifi_gateway" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12 mb-2">
                                                        <div class="form-group">
